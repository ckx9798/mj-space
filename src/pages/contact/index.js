    ...
    <>
      ...
      >
        <motion.div
          ...
          className="sticky top-52 flex w-full max-w-lg animate-glowPulse flex-col items-center rounded-3xl bg-gray-800/30 p-10 text-white shadow-2xl backdrop-blur-lg hover:scale-105"
        >
          <ContactIntro />
          <ContactInfo />
